    ...
    <section id={props.sectionId}>
      ...
      >
        <div className={styles['summary-content-container']}>
          ...
          {props.PROGRESS_CARD_LABEL && props.highlightedResults.length > 0 && (
            <div
              style={{
                marginTop: '6rem'
              }}
