...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function success(e) {
      ...
      var cartNoItems = $('.siteHeader-basket').attr('data-cart-no-items');
      ...
      if (e.item_count > 0) {
        ...
        $('.siteHeader-basket').attr('aria-label', l + '. ' + e.item_count + ' ' + cartM);
      } else {
        $('.siteHeader-basket').attr('aria-label', l + '. ' + cartNoItems);
      }
