...
header_controller.searchBox = {
    ...
    init: function () {
        this.selector.on('click', function (cb) {
            var $this = $(this), s = $('.grid-search-wrapper'),
              l = $('.site-lang-wrapper'), tc = $(".siteHeader-searchToggle .toggle-close");
    ...
    this.selector.on('DOMNodeInserted', function (e) {
      if ($(e.target).hasClass('gsc-input') && $(e.target).is('input')) {
        ...
        target.on('blur', function () {
          ...
          setTimeout(function () { $(".siteHeader-searchToggle").css("pointer-events", ""); }, 500);
...
header_controller.langBox = {
    ...
    init: function () {
        ...
        $('.lang-selector-container a:last-child').on("blur", function () {
            header_controller.langBox.selector.removeClass("show").attr("aria-expanded","false");
        });
    }
};
/* -------------------------------------------------------------------------- *\
...
header_controller.nav = {
    ...
    init: function () {
      ...
      $("#btnCloseMwvMenu").focus(function () {
      ...
      s1.on('keydown', function (e) {
        ...
        if (e.keyCode === 9 && isModalMenu) {
          if (e.shiftKey) {
            ...
            else if (document.activeElement === $(".siteHeader-navItem").last()[0]) {
              e.preventDefault();
              $("#btnCloseMwvMenu")[0].focus();
              return;
            }
      ...
      $('#chatLaunchButton').focus(function () {
        $(this).css("outline", "2px solid #7BB2CE").css("outline-offset", "2px");
      }).blur(function () {
        $(this).css("outline", "none");
      });

      $(".siteHeader-hamburger,.siteHeader-searchToggle.u-hide-desktop,.siteHeader-basket.siteHeader-top-button,.site-lang.siteHeader-topItem").focus(function () {
        $(this).css("outline", "2px solid #7BB2CE").css("outline-offset", "5px");
      }).blur(function () {
        $(this).css("outline", "none");
      });
      $(".siteHeader-logo").parent().focus(function () {
        $(this).css("outline", "2px solid #7BB2CE");
...
header_controller.close = {
    selector: $('.wrapper-close, .wrapper-close.siteHeader-close, .main-overlay, #btnMwvLogin-Mobile'),
